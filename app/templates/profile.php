    ...
    <div class="row">
        <div class="col-md-3 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                <img class="rounded-circle mt-5" width="150px" src="assets/images/Barangay.png" alt="profilepic"><h3>Resident</h3><?php echo $_SESSION['username']; ?><h5></h5></div>
            </div>
        <div class="col-md-8 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-3">
                    <div class="col-md-12"><label class="labels">Full Name</label><input type="text" class="form-control" value="<?php echo $_SESSION['fullname']; ?>" disabled></div>
