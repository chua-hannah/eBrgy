    ...
    <h2 class="mb-4 text-center">Register an account</h2>
        <div class="row d-flex justify-content-center align-items-center">
            <div class="col-lg-9 col-12">
                <form class="custom-form volunteer-form mb-4 align-items-center needs-validation" id="register" action="" method="post" enctype="multipart/form-data" role="form" novalidate>
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-lg-4 col-12">
                            ...
                            id="firstname" placeholder="First name" value="<?php if (!empty($_POST["firstname"])) { echo $_POST["firstname"]; } else { echo ''; };?>">
                        ...
                        <div class="col-lg-4 col-12">
                            ...
                            <?php echo isset($errors["lastname"]) ? 'is-invalid' : ''; ?>" id="lastname" placeholder="Last name" value="<?php if (!empty($_POST["lastname"])) { echo $_POST["lastname"]; } else { echo ''; };?>">
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <?php echo isset($errors["birthdate"]) ? 'is-invalid' : ''; ?>" id="birthdate" placeholder="Birthdate (MM/DD/YYYY)" value="<?php if (!empty($_POST["birthdate"])) { echo $_POST["birthdate"]; } else { echo ''; };?>">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="input-group">
                                ...
                                <?php echo isset($errors["mobile"]) ? 'is-invalid' : ''; ?>" name="mobile" id="mobile" placeholder="Mobile Number" oninput="validateNumericInput(this)" maxlength="10" value="<?php if (!empty($_POST["mobile"])) { echo $_POST["mobile"]; } else { echo ''; };?>">
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <?php echo isset($errors["email"]) ? 'is-invalid' : ''; ?>" id="email" placeholder="Email address" value="<?php if (!empty($_POST["email"])) { echo $_POST["email"]; } else { echo ''; };?>">
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <?php echo isset($errors["username"]) ? 'is-invalid' : ''; ?>" id="username" placeholder="Create Username (Must be 6 characters long)" value="<?php if (!empty($_POST["username"])) { echo $_POST["username"]; } else { echo ''; };?>">
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <?php echo isset($errors["password"]) ? 'is-invalid' : ''; ?>" id="password" placeholder="Nominate Password (Minimum of 8 characters)" required>
