...
<div class="container-fluid">
    ...
    <?php if (is_array($schedulesData) || is_object($schedulesData)) { ?>
        <?php if (count($schedulesData) === 0) { ?>
            <p class="text-center">No schedule/s available for the selected date. </p>
            <form method="post" action="">
                <button type="submit" class="link-button" name="showLatest">View the Latest Schedule</button>
            </form>
        <?php } else { ?>
    ...
    <tr>
        <td><?php echo $scheduleData['firstname'] . " " . $scheduleData['middlename'] . " " . $scheduleData['lastname']; ?></td>
        <td><?php echo $scheduleData['mobile']; ?></td>
    ...
    <?php } ?>
    <?php } else { ?>
        <h6 style="text-align: left;">List of Latest Schedule</h6>
