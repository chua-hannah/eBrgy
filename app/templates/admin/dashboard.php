            ...
            <div class="col-md-4 pb-4">
                <div class="card custom-card" style="background: linear-gradient(135deg, #FFA07A, #FF6B8B); height: 100vh;">
                    ...
                    <h3 class="text-center my-2" style="display: flex; justify-content: center">
                            ...
                            <div class="mt-2"> <i class="bi bi-people" style="font-size: 2rem;"></i> Users</div>
                        </h3>
                     
                    </div>
                    <div class="card-body">
                    <h6>User List</h6>
                    <h6 class="fw-light"><i class="bi bi-person" style="font-size: 1rem;"></i> Active Users: <?php echo $data['totalActiveUsers']; ?></h6>
                    <h6 class="fw-light"><i class="bi bi-clock" style="font-size: 1rem;"></i> Pending Users: <?php echo $data['totalUsers']; ?></h6>
                    <h6 class="fw-light"><i class="bi bi-person-fill" style="font-size: 1rem;"></i> Admins: <?php echo $data['totalAdmins']; ?></h6>
                    <h6 class="fw-light"><i class="bi bi-house" style="font-size: 1rem;"></i> Resident Users: <?php echo $data['totalResidences']; ?></h6>
                    <h6 class="fw-light"><i class="bi bi-people" style="font-size: 1rem;"></i> Seniors: <?php echo $data['totalSenior']; ?></h6>                    
                    <h6 class="fw-light"><i class="bi bi-bank" style="font-size: 1rem;"></i> 4PS: <?php echo $data['totalFourps']; ?></h6>
                    <h6 class="fw-light"><i class="bi bi-person" style="font-size: 1rem;"></i> PWD : <?php echo $data['totalPwd']; ?></h6>
                    <h6 class="fw-light"><i class="bi bi-person-arms-up" style="font-size: 1rem;"></i> Solo Parent : <?php echo $data['totalSoloParent']; ?></h6>
                    <h6 class="fw-light"><i class="bi bi-book" style="font-size: 1rem;"></i> Scholar: <?php echo $data['totalScholar']; ?></h6>
                    <h6 class="mt-5">Master List</h6>
                    <h6 class="fw-light"><i class="bi bi-people-fill" style="font-size: 1rem;"></i> Families: <?php echo $families; ?></h6>
                    <h6 class="fw-light"><i class="bi bi-house" style="font-size: 1rem;"></i> Residences: <?php echo $data['masterlistUsers']; ?></h6>
                    <h6 class="fw-light"><i class="bi bi-people" style="font-size: 1rem;"></i> Seniors: <?php echo $data['masterlistSenior']; ?></h6>
                    <h6 class="fw-light"><i class="bi bi-bank" style="font-size: 1rem;"></i> 4PS: <?php echo $data['masterlistFourps']; ?></h6>
                    <h6 class="fw-light"><i class="bi bi-person" style="font-size: 1rem;"></i> PWD : <?php echo $data['masterlistPwd']; ?></h6>
                    <h6 class="fw-light"><i class="bi bi-person-arms-up" style="font-size: 1rem;"></i> Solo Parent : <?php echo $data['masterlistSoloParent']; ?></h6>
                    <h6 class="fw-light"><i class="bi bi-book" style="font-size: 1rem;"></i> Scholar: <?php echo $data['masterlistScholar']; ?></h6>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 pb-4">
                <div class="card custom-card h-100" style="background: linear-gradient(135deg, #FFC3A0, #FFAFBD); height: 100vh;">
                    ...
                    <?php foreach ($data['lateAttendees'] as $lateAttendee) { ?>
                        <p class="attendee-name late-attendee text-danger" style="margin-left: 20px;">
