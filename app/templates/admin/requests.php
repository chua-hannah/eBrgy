            ...
            <div class="text-center">
                ...
                <div class="col-lg-6 col-md-6 col-xl-6 col-sm-12 my-2">
                            <a href="/eBrgy/app/requests-documents" class="d-block">
                                <img src="assets/images/icons/stamp.png" class="featured-block-image" alt="" style="height: 150px;">
                                <p class="featured-block-text"><strong>Documents</strong></p>
                            </a>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xl-6 col-sm-12 my-2">
                            <a href="/eBrgy/app/requests-reports" class="d-block">
                                <img src="assets/images/icons/letter.png" class="featured-block-image" alt=""style="height: 150px;" >
                    ...
                    <div class="col-lg-6 col-md-6 col-xl-6 col-sm-12 my-2">
                     ...
                     <div class="col-lg-6 col-md-6 col-xl-6 col-sm-12 my-2">
                            <a href="/eBrgy/app/requests-schedules" class="d-block">
                                <img src="assets/images/icons/bb.png" class="featured-block-image" alt="" style="height: 150px;">
