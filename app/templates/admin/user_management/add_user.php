...
<div class="container mt-5">
    ...
    <div class="row g-2">
                        ...
                        <div class="col-lg-12 col-12 mb-2">
                            <select class="form-select text-center" name="role" placeholder="Gender" required>
                                <option value="" disabled selected>ROLE</option>
                                <option value="captain" <?php if(isset($_POST["role"]) && $_POST["role"]=="captain"){ echo 'selected';} ?>>Captain</option>
                                <option value="kagawad" <?php if(isset($_POST["role"]) && $_POST["role"]=="kagawad"){ echo 'selected';} ?>>Kagawad</option>
                            </select>
                        </div> 
                    </div>
                    <button type="submit" name="add-officials" class="form-control btn btn-success mb-3">Register Official</button>
    </form>
</div>
